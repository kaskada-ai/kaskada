...
test/int/run-api:
	LOCAL=true go run github.com/onsi/ginkgo/v2/ginkgo -v tests/integration/...

test/int/run-api-s3:
	LOCAL=true OBJECT_STORE_TYPE=s3 OBJECT_STORE_PATH=/data go run github.com/onsi/ginkgo/v2/ginkgo -v tests/integration/...

test/int/run-api-postgres:
	LOCAL=true DB_DIALECT="postgres" go run github.com/onsi/ginkgo/v2/ginkgo -v tests/integration/...

test/int/run-api-postgres-s3:
	LOCAL=true DB_DIALECT="postgres" OBJECT_STORE_TYPE=s3 OBJECT_STORE_PATH=/data go run github.com/onsi/ginkgo/v2/ginkgo -v tests/integration/...
