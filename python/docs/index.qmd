...
<img class="d-block mx-auto mb-4 only-light" src="source/_static/kaskada-positive.svg" alt="" width="50%">
<img class="d-block mx-auto mb-4 only-dark" src="source/_static/kaskada-negative.svg" alt="" width="50%">
