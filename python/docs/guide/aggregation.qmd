...
Windowed
: They reflect the values within a specific [window](../reference/windows.qmd).
...
The [windows reference](../reference/windows.qmd) has information on the supported kinds of windows.
