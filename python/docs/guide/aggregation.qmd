...
Windowed
: They reflect the values within a specific [window](../reference/index.qmd#windows).
...
The [windows reference](../reference/index.qmd#windows) has information on the supported kinds of windows.
