...
```{.python filename="Joining two event streams to compute page-views per purchase"}
...
Values from associated with other entities may be retrieved using [`kaskada.Timestream.lookup`](../reference/Timestream.lookup.qmd).
