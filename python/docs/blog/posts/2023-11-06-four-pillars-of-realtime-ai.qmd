...
Imagine a world where LLMs take actions you request – sending an e-mail for you or scheduling a meeting based on multiple people’s calendar.
Imagine LLMs automatically reacting by categorizing incoming e-mail messages or monitoring the news for articles you’d be interested in.
Imagine LLMs proactively deciding an email was worth your attention and presenting a summary to you, with the relevant information.
...
The set of actions and when (and how) to include the human in the loop depends on the real-time application.
Needless to say, this is another place where human judgment will be needed when creating real-time AI applications.
