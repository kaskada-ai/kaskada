...
You can visit the https://github.com/kaskada-ai/kaskada/releases[Releases] page on Github to obtain the latest Kaskada release version.
This example assumes you have installed `curl` and uses Kaskada version `v0.5.4`. 
