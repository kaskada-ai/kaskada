...
This example assumes you have installed `curl` and uses version `v0.5.4`. 
You can visit the xref:url:https://github.com/kaskada-ai/kaskada/releases[Releases] page on Github to obtain the latest Kaskada release version.
