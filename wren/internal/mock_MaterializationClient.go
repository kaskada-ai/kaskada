...
// GetMaterializationsFromNames provides a mock function with given fields: ctx, owner, names
func (_m *MockMaterializationClient) GetMaterializationsFromNames(ctx context.Context, owner *ent.Owner, names []string) (map[string]*ent.Materialization, error) {
	ret := _m.Called(ctx, owner, names)

	var r0 map[string]*ent.Materialization
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Owner, []string) (map[string]*ent.Materialization, error)); ok {
		return rf(ctx, owner, names)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Owner, []string) map[string]*ent.Materialization); ok {
		r0 = rf(ctx, owner, names)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]*ent.Materialization)
		}
	}
...
// MockMaterializationClient_GetMaterializationsFromNames_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetMaterializationsFromNames'
type MockMaterializationClient_GetMaterializationsFromNames_Call struct {
	*mock.Call
}

// GetMaterializationsFromNames is a helper method to define mock.On call
//   - ctx context.Context
//   - owner *ent.Owner
//   - names []string
func (_e *MockMaterializationClient_Expecter) GetMaterializationsFromNames(ctx interface{}, owner interface{}, names interface{}) *MockMaterializationClient_GetMaterializationsFromNames_Call {
	return &MockMaterializationClient_GetMaterializationsFromNames_Call{Call: _e.mock.On("GetMaterializationsFromNames", ctx, owner, names)}
}

func (_c *MockMaterializationClient_GetMaterializationsFromNames_Call) Run(run func(ctx context.Context, owner *ent.Owner, names []string)) *MockMaterializationClient_GetMaterializationsFromNames_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*ent.Owner), args[2].([]string))
	})
	return _c
...
func (_c *MockMaterializationClient_GetMaterializationsFromNames_Call) Return(_a0 map[string]*ent.Materialization, _a1 error) *MockMaterializationClient_GetMaterializationsFromNames_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMaterializationClient_GetMaterializationsFromNames_Call) RunAndReturn(run func(context.Context, *ent.Owner, []string) (map[string]*ent.Materialization, error)) *MockMaterializationClient_GetMaterializationsFromNames_Call {
	_c.Call.Return(run)
	return _c
}
...
// IncrementVersion provides a mock function with given fields: ctx, materialization
func (_m *MockMaterializationClient) IncrementVersion(ctx context.Context, materialization *ent.Materialization) (*ent.Materialization, error) {
	ret := _m.Called(ctx, materialization)

	var r0 *ent.Materialization
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Materialization) (*ent.Materialization, error)); ok {
		return rf(ctx, materialization)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *ent.Materialization) *ent.Materialization); ok {
		r0 = rf(ctx, materialization)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*ent.Materialization)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, *ent.Materialization) error); ok {
		r1 = rf(ctx, materialization)
	} else {
		r1 = ret.Error(1)
	}
...
// MockMaterializationClient_IncrementVersion_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IncrementVersion'
type MockMaterializationClient_IncrementVersion_Call struct {
	*mock.Call
}
...
func (_e *MockMaterializationClient_Expecter) IncrementVersion(ctx interface{}, materialization interface{}) *MockMaterializationClient_IncrementVersion_Call {
	return &MockMaterializationClient_IncrementVersion_Call{Call: _e.mock.On("IncrementVersion", ctx, materialization)}
}

func (_c *MockMaterializationClient_IncrementVersion_Call) Run(run func(ctx context.Context, materialization *ent.Materialization)) *MockMaterializationClient_IncrementVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*ent.Materialization))
	})
	return _c
}

func (_c *MockMaterializationClient_IncrementVersion_Call) Return(_a0 *ent.Materialization, _a1 error) *MockMaterializationClient_IncrementVersion_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockMaterializationClient_IncrementVersion_Call) RunAndReturn(run func(context.Context, *ent.Materialization) (*ent.Materialization, error)) *MockMaterializationClient_IncrementVersion_Call {
	_c.Call.Return(run)
	return _c
}
