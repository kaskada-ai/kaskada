...
async fn test_coalesce_two_boolean() {
    insta::assert_snapshot!(QueryFixture::new("{ a: Booleans.a, b: Booleans.b, coalesce_a_b: Booleans.a | coalesce($input, Booleans.b) }").run_to_csv(&boolean_data_fixture()).await.unwrap(), @r###"
...
async fn test_coalesce_zero() {
    insta::assert_yaml_snapshot!(QueryFixture::new("{ m: Numbers.m, coalesce_m: coalesce() }").run_to_csv(&i64_data_fixture()).await.unwrap_err(), @r###"
    ---
...
async fn test_coalesce_one_i64() {
    insta::assert_snapshot!(QueryFixture::new("{ m: Numbers.m, coalesce_m: coalesce(Numbers.m) }").run_to_csv(&i64_data_fixture()).await.unwrap(), @r###"
...
async fn test_coalesce_one_i64_one_literal_i64() {
    insta::assert_snapshot!(QueryFixture::new("{ n: Times.n, coalesce_n_literal: coalesce(Times.n, 12345) }").run_to_csv(&timestamp_ns_data_fixture()).await.unwrap(), @r###"
...
async fn test_coalesce_one_i64_one_literal_f64() {
    insta::assert_snapshot!(QueryFixture::new("{ n: Times.n, coalesce_n_literal: coalesce(Times.n, 12345.7) }").run_to_csv(&timestamp_ns_data_fixture()).await.unwrap(), @r###"
    _time,_subsort,_key_hash,_key,n,coalesce_n_literal
...
async fn test_coalesce_two_i64() {
    insta::assert_snapshot!(QueryFixture::new("{ m: Numbers.m, n: Numbers.n, coalesce_m_n: coalesce(Numbers.m, Numbers.n) }").run_to_csv(&i64_data_fixture()).await.unwrap(), @r###"
...
async fn test_coalesce_two_i64_one_literal() {
    insta::assert_snapshot!(QueryFixture::new("{ m: Numbers.m, n: Numbers.n, coalesce_m_n: coalesce(Numbers.m, Numbers.n, 42) }").run_to_csv(&i64_data_fixture()).await.unwrap(), @r###"
    _time,_subsort,_key_hash,_key,m,n,coalesce_m_n
    1996-12-20T00:39:57.000000000,9223372036854775808,3650215962958587783,A,5,10,5
    1996-12-20T00:39:58.000000000,9223372036854775808,11753611437813598533,B,24,3,24
    1996-12-20T00:39:59.000000000,9223372036854775808,3650215962958587783,A,17,6,17
...
async fn test_coalesce_two_f64() {
    insta::assert_snapshot!(QueryFixture::new("{ m: Numbers.m, n: Numbers.n, coalesce_m_n: coalesce(Numbers.m, Numbers.n) }").run_to_csv(&f64_data_fixture()).await.unwrap(), @r###"
    _time,_subsort,_key_hash,_key,m,n,coalesce_m_n
...
async fn test_coalesce_two_string() {
    insta::assert_snapshot!(QueryFixture::new("{ s: Strings.s, t: Strings.t, coalesce_s_t: coalesce(Strings.s, Strings.t) }").run_to_csv(&strings_data_fixture()).await.unwrap(), @r###"
...
async fn test_coalesce_two_timestamp_ns() {
    insta::assert_snapshot!(QueryFixture::new("{ m: Times.m, n: Times.n, coalesce_m_n: coalesce(Times.m, Times.n) }").run_to_csv(&timestamp_ns_data_fixture()).await.unwrap(), @r###"
    _time,_subsort,_key_hash,_key,m,n,coalesce_m_n
...
async fn test_coalesce_two_record() {
    insta::assert_snapshot!(QueryFixture::new("{ m: Times.m, n: Times.n, coalesce_times_times: coalesce(Times, Times) | $input.n }").run_to_csv(&timestamp_ns_data_fixture()).await.unwrap(), @r###"
...
async fn test_coalesce_incompatible_types() {
    insta::assert_yaml_snapshot!(QueryFixture::new("{ m: Numbers.m, coalesce_m: coalesce(Numbers.m, \"hello\") }").run_to_csv(&i64_data_fixture()).await.unwrap_err(), @r###"
    ---
    code: Client specified an invalid argument
    message: 1 errors in Fenl statements; see diagnostics
    fenl_diagnostics:
