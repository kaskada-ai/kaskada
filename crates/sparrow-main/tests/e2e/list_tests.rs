...
async fn test_index_list_i64_dynamic() {
    ...
    1996-12-19T16:40:59.000000000,0,18433805721903975440,1,1
    1996-12-19T16:41:57.000000000,0,18433805721903975440,1,1
    ...
    fenl_diagnostics:
      - severity: error
        ...
        formatted:
          ...
          - "  |"
          - "  --> built-in signature 'index<T: any>(i: i64, list: list<T>) -> T':1:22"
          - "  |"
