...
async fn test_when_cond() {
    ...
    1996-12-20T00:40:02.000000000,0,12960666915911099378,A,1996-12-20T00:40:02.000000000,0,A,true,,2,hello
    "###)
}
...
async fn test_i64_when() {
    ...
    1996-12-20T00:40:00.000000000,0,12960666915911099378,A,
    1996-12-20T00:40:02.000000000,0,12960666915911099378,A,2
    "###);
}
...
async fn test_timestamp_when() {
    ...
    _time,_subsort,_key_hash,_key,when
    1996-12-20T00:39:57.000000000,0,12960666915911099378,A,1996-12-20T00:39:57.000000000
    1996-12-20T00:40:00.000000000,0,12960666915911099378,A,1996-12-20T00:40:00.000000000
    1996-12-20T00:40:02.000000000,0,12960666915911099378,A,1996-12-20T00:40:02.000000000
    "###);
}
...
async fn test_string_when() {
    ...
    1996-12-20T00:40:00.000000000,0,12960666915911099378,A,
    1996-12-20T00:40:02.000000000,0,12960666915911099378,A,hello
    "###);
}
...
async fn test_record_when() {
    ...
    _time,_subsort,_key_hash,_key,time,subsort,key,cond,bool,i64,string
    1996-12-20T00:39:57.000000000,0,12960666915911099378,A,1996-12-20T00:39:57.000000000,0,A,true,false,57,hello
    1996-12-20T00:40:00.000000000,0,12960666915911099378,A,1996-12-20T00:40:00.000000000,0,A,true,,,
    1996-12-20T00:40:02.000000000,0,12960666915911099378,A,1996-12-20T00:40:02.000000000,0,A,true,,2,hello
    "###);
}
