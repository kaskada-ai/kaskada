...
pub(crate) struct TwoStacksFirstBooleanEvaluator {
    pub args: AggregationArgs<ValueRef>,
    pub token: TwoStacksBooleanAccumToken<FirstBoolean>,
}

impl Evaluator for TwoStacksFirstBooleanEvaluator {
...
impl TwoStacksFirstBooleanEvaluator {
    fn ensure_entity_capacity(
        accum: &mut Vec<TwoStacks<FirstBoolean>>,
    ...
    fn update_two_stacks_accum(
        accum: &mut [TwoStacks<FirstBoolean>],
        entity_index: u32,
        input_is_valid: bool,
...
mod tests {
    ...
    #[test]
    fn test_sliding_boolean_first_with_no_null() {
        // With no null values
        ...
        let output = TwoStacksFirstBooleanEvaluator::aggregate(
            &mut accum,
            1,
            &entity_indices,
            &input,
