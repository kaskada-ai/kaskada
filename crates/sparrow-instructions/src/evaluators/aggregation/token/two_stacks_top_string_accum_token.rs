...
/// Key used for windowed top string accumulators using two-stacks
/// implementation.
///
/// Stored as `[passId, instId, entity_index] -> TwoStacks<AggF>`
pub struct TwoStacksTopStringAccumToken<AggF>
where
    AggF: AggFn,
{
    /// Stores the state.
...
impl<AggF> StateToken for TwoStacksTopStringAccumToken<AggF>
where
    AggF: AggFn,
...
impl<AggF> TwoStacksTopStringAccumToken<AggF>
where
    AggF: AggFn,
{
