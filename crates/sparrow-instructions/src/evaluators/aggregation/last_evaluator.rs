...
impl Evaluator for LastEvaluator {
...
impl EvaluatorFactory for LastEvaluator {
...
mod tests {
    ...
    fn test_last_list_multiple_batches() {
        ...
        let result =
            LastEvaluator::aggregate(&mut token, key_capacity, &key_indices, &input).unwrap();
    ...
    #[test]
    fn test_larst_map_multiple_batches() {
    ...
    fn test_last_f64() {
        ...
        let output = LastEvaluator::aggregate(&mut token, 3, &entity_indices, &input).unwrap();
